...
public class SehenwuerdigkeitenTexte {
    ...
    public  void InitLists(){
        ...
        for ( Field field : fields  ) {
            try {
                if(field.getName().endsWith("_d")) deutscheTexte.put(field.getName().toLowerCase(),field.get(this).toString());
                else if(field.getName().endsWith("_e")) englischeTexte.put(field.getName().toLowerCase(), field.get(this).toString());
